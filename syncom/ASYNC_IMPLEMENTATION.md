...
4. **syncom/argument_mapper.py**
   - Added `map_argument_async()` function

5. **syncom/quality_control.py**
...
- `syncom/config.py` - Async client factory methods
- `syncom/generator.py` - Async generation functions
- `syncom/persona.py` - Async persona sampling
- `syncom/argument_mapper.py` - Async frame mapping
- `syncom/quality_control.py` - Async QC checks
- `syncom/pipeline.py` - Async orchestration
