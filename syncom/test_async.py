...
def test_imports():
    ...
    try:
        ...
        from syncom.persona import sample_persona_async
        from syncom.argument_mapper import map_argument_async
        from syncom.quality_control import QualityController
        from syncom.pipeline import run_async, _generate_one_comment_async
...
def test_pipeline_has_run_async():
    ...
    from syncom.pipeline import run_async
