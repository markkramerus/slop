...
def main():
    ...
    # Default file paths
    input_file = 'synthetic_comments_3.txt'
    output_file = 'synthetic_comments_translated_to_cms.csv'
    
    # Check if custom file paths provided as arguments
    if len(sys.argv) > 1:
    ...
    if not Path(input_file).exists():
        print(f"Error: Input file '{input_file}' not found.")
        print("\nUsage: python translate_to_cms_format.py [input_file] [output_file]")
        sys.exit(1)
